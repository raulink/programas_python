...
doc = DocxTemplate("sp-plantilla-rrhh-info.docx")
mi_nombre = "Raul Mamani cusi"
mi_numero = "(591) 79568052"
mi_correo = "frank@gmail.com"
mi_direccion = "Zona Mercedario"
...
df = pd.read_csv('sp_fake_data.csv')
...
for index, fila in df.iterrows():
    ...
    doc.render(context)
    doc.save(f"output/doc_generado_{index}.docx")